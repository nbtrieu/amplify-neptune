const keywordOptionsList = [
  'NGS', 'RNA', 'E.coli', 'None-General', 'Vendor', 'Epigenetics', 'Cell-free', 'Yeast', 
  'Protein & Enzymes', 'Automation', 'Co-purification', 'BusDev', 
  ...
  'Sample Collection', 'Plamid', 'Assays', 'Microbiomics', 'Services', 'pk supply'
];
